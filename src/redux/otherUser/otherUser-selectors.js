...
export const selectUserSubscriptions = ({ otherUser }) => otherUser.userSubscriptions;
export const selectTotalPagesUserSubscription = ({ otherUser }) => otherUser.totalPagesUserSubscription;